...
newdataset = dataset
result=data.frame(newdataset[,151:168])
newdataset[,151:168]=NULL
...
#New Type of data needed for Decision Tree Function
...
#................ Decision Tree Model.....................
classifier = rpart(formula = Severity_O1_1_Cash ~ .,
                   data = training[,2:274])

y_predict = predict(classifier, newdata = test[-150])

predicted_Value = c(round(y_predict,digit=0))
test_value=c(test$Severity_O1_1_Cash) 

#Checking accuracy
i=1
count=0
while (i<515) {
  if(predicted_Value[i] == test_value[i]){
    count=count+1
  }
  i=i+1
}
